...
def rowselect(request,id):
    ...
    com_table=commentsmodel.objects.filter(user_id=id,idprefix=idprefix).order_by('refpath').first()
    ...
    return render(request, 'rd/comments_view_doc.html',{'form':form,'details': taf})
