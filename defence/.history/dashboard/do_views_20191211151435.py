...
def rowselect(request,id):
    ...
    for anex_name in get_refpath:
        context['anexturename']=anex_name.refpath
        comments = commentsmodel(name=context,commented_date=formatted_datetime,commented_by=role,idprefix=idprefix,user_id=id)

    print(context,'taff')
    print(comments,'taffq')
