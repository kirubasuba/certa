...
def addcomment(request):
    ...
    # comments = commentsmodel(name=anexture_name,comments=comments,commented_date=formatted_datetime,
    # commented_by=role,responsible=responsible,idprefix=idprefix,status=status,user_id=id)
    # commentsdb=comments.save()
    ...
    # get_cmd_id.responsible=responsible
    # get_cmd_id.save()
