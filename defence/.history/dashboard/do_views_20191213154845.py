...
def addcomment(request):
    ...
    comments = commentsmodel(name=anexture_name,comments=comments,commented_date=formatted_datetime,commented_by=role,responsible=responsible,idprefix=idprefix,status=status,user_id=id)
    comments.save()
