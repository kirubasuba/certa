...
def rowselect(request,id):
    ...
    comData=commentsmodel.objects.filter(user_id=id,idprefix=idprefix).order_by('name').first()
    print(comData,'taff')
    ...
    return render(request, 'rd/comments_view_doc.html',{'form':form,'details': comData})
