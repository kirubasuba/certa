...
def addcomment(request,id):
    ...
    idprefix=request.POST['comments']
    idprefix=request.POST['responsible']
    idprefix=request.POST['status']  
    print(idprefix,anexture_name,'idprefix')
    
    get_taap_id=commentsmodel.objects.filter(TAA_id=reg_by_id.id).first()
