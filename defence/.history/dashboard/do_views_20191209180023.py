...
from .forms import UserCreationForm,TAapplicationForm,cemilacUserForm,proforma_A_form
from django.contrib import messages
from common.decorators import role_required
from authmgmt.models import registration
from .models import TAapplicationmodel,proforma_A_model,TAapplicationfiles,statusmodel
...
@login_required(login_url=settings.LOGIN_URL)
def comments_doc_views(request):
    # form=fileUploadForm
    ...
    # return render(request, 'applicant/comments_view_doc.html',{'form':form,'details': taf,'idg':idg,'idprefix':idprefix})
    return render(request, 'applicant/comments_view_doc.html')
