...
def rowselect(request,id):
    ...
    role=request.role
    print(role,'role')
    comments_model = commentsmodel(name=taff,commented_date=formatted_datetime,commented_by=role,idprefix=idprefix,user_id=id)
    comments_model_db=comments_model.save()
